...
case class CliArgumentOutputType() extends CliArgument("--output-type", Some(List[CliArgumentValue](CliArgumentValueOutputTypeJson(), CmdArgumentValueOutputTypeCli(), CliArgumentValueOutputTypeCsv(), CliArgumentValueOutputTypeYaml())))
