...
case class CliArgumentOutputType() extends CliArgument("--output-type", Some(List[CliArgumentValue](CliArgumentValueOutputTypeFile(), CmdArgumentValueOutputTypeCli())))
